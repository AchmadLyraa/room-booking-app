...
export async function getUsersData(): Promise<SeedUser[]> {
  return [
    // ADMIN
    {
      name: "Admin",
    ...
    {
      name: "DENI PURWOWISESO",
      email: "Denipurwo31@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "8717043TKM",
      bidang: "K3 & Keamanan",
    ...
    {
      name: "ABRIADI SAID",
      email: "abriadisaid010@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9623475WTK",
      bidang: "K3 & Keamanan",
    ...
    {
      name: "GERRY RISTIAN",
      email: "gerryristian01@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9624465WTK",
      bidang: "K3 & Keamanan",
    ...
    {
      name: "MASDUKI AFIF",
      email: "masduki.afif71@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0024466WTK",
      bidang: "K3 & Keamanan",
    ...
    {
      name: "HERI FALENTINO",
      email: "Haryvalentino14@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9925484WTK",
      bidang: "Rendal Operasi",
    ...
    {
      name: "MUHAMMAD MAHFUD",
      email: "Muhammadmahfud061194@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9416013TKM",
      bidang: "Produksi A",
    ...
    {
      name: "HAMDAN JAWAA HIRUL MA'ANI",
      email: "Hamdanputra99@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9616008TKM",
      bidang: "Produksi A",
    ...
    {
      name: "IRWAN SAROJI",
      email: "Irwansaroji123@yahoo.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "8816029TKM",
      bidang: "Produksi A",
    ...
    {
      name: "SONY DWI ZAINURI",
      email: "Mfachriaffanzainuri@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "8916025TKM",
      bidang: "Produksi A",
    ...
    {
      name: "MUHAMMAD IQBAL",
      email: "Muhammadiqbal220412@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0023478WTK",
      bidang: "Produksi A",
    ...
    {
      name: "ASPUL ANWAR",
      email: "nwaybalikpapan@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9324473WTK",
      bidang: "Produksi A",
    ...
    {
      name: "HERI SUPRIANTO",
      email: "Herisuprianto06@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "8817063TKM",
      bidang: "Produksi B",
    ...
    {
      name: "KARYONO",
      email: "Fazilfazilfazil@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "8916024TKM",
      bidang: "Produksi B",
    ...
    {
      name: "MUHAMMAD JEFRIANTO",
      email: "Muhammadjefery.92@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9216020TKM",
      bidang: "Produksi B",
    ...
    {
      name: "SANDY RAMADHANI",
      email: "Sandhramadhani108@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9516023TKM",
      bidang: "Produksi B",
    ...
    {
      name: "ARFAN DARMAWAN",
      email: "arvhandermawan0205@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9325487WTK",
      bidang: "Produksi B",
    ...
    {
      name: "MUHAMMAD RANGGA CAHYADI",
      email: "Rangga0528@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9619097TKM",
      bidang: "Produksi C",
    ...
    {
      name: "GUINES ADI NUGROHO",
      email: "guinesnugroho@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9324472WTK",
      bidang: "Produksi C",
    ...
    {
      name: "MOHAMMAD RISKI PRAYOGA",
      email: "xyogaaa@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9925490WTK",
      bidang: "Produksi C",
    ...
    {
      name: "SETIAWAN",
      email: "Setiawanputrabalikpapan@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9316034TKM",
      bidang: "Produksi D",
    ...
    },
    {
      ...
      email: "adityaulumudin1997@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9723485WTK",
      bidang: "Produksi D",
    ...
    {
      name: "KEVIN MAGHRIZA KRISNA BAKTI",
      email: "kevinmaghriza@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9922469WTK",
      bidang: "Produksi D",
    ...
    {
      name: "HOUTMAN SAMOSIR",
      email: "Hotmansamosir2496@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9616029TKM",
      bidang: "Produksi D",
    ...
    {
      name: "IBRAHIM",
      email: "iiibrhmbusiness@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0423477WTK",
      bidang: "Produksi D",
    ...
    {
      name: "FRENDI RANDAKILA",
      email: "Rendyrandakila@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0223483WTK",
      bidang: "Produksi D",
    ...
    {
      name: "DWI AGUS ARJANTO",
      email: "dwiarya544@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9825476WTK",
      bidang: "Produksi D",
    ...
    {
      name: "GUGUN GUMELAR",
      email: "Gugungumelar32739@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9920466WTK",
      bidang: "Kimia",
    },
    {
      ...
      email: "Doniputra19793@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9323476WTK",
      bidang: "Kimia",
    ...
    {
      name: "KHRIS DIANTO TOMBOKAN",
      email: "Khrisdiantotombokan@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9617040TKM",
      bidang: "Rendal Pemeliharaan",
    ...
    {
      name: "AZAN YAMANI PURWANTO",
      email: "azanyaminip@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0025489WTK",
      bidang: "Rendal Pemeliharaan",
    ...
    },
    {
      ...
      role: Role.PIC,
      nid: "9216226ZJY",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    },
    {
      name: "HERI SISWANTO",
    ...
    {
      name: "AGUNG WIDODO",
      email: "Agungwidodo664@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9617062TKM",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "HERIADI RIZKY",
      email: "Heriadirizky016@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9517052TKM",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "MUH. MARWAN",
      email: "Mhmmadmarwan68@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9717074TKM",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "SAFRILIANTO TRI NUR WICAKSONO",
      email: "Safriliantotnw@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9617047TKM",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "SEPRIADI SAPUTRA",
      email: "Sepriadisaputra123@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9617046TKM",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "WAHID KURNIAWAN",
      email: "Kurniawanwahid27@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9117045TKM",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "MIFTAHUL HUDA",
      email: "miftahulhudha9656@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9822470WTK",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "JONATHAN PETER NICHOLAS",
      email: "jonathanptr044@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0223479WTK",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "MUHAMMAD RIZKY FAHRIANSYAH",
      email: "mr.ayiii24062002@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0224474WTK",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    ...
    {
      name: "ANDY EGAR FIRMANSYAH",
      email: "andyegarfirmansyah20@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0424583WTK",
      bidang: "Pemeliharaan Mesin 1 B, T & AAB",
    },
    {
      ...
      role: Role.PIC,
      nid: "9016097TB",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    },
    {
    ...
    {
      name: "ROBERT SIRANDA",
      email: "Robertsiranda98@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9817056TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "ALFINDRA DWI SURYA",
      email: "alfindradwi2@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9717086TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "ARDIANSYAH EFFENDI",
      email: "Ardiansyah2223@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9317084TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "HERLAN ISRUL RAJAB",
      email: "Herlanisrulrajab@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9218093TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "MUHAMMAD JUNIANUR RIZKI",
      email: "Junianur201@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9616030TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "RIAN CAHYADI",
      email: "Riancahyadi280696@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9616038TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "YULIZAR FITRA YUSER",
      email: "yulizaryuser@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9018094TKM",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "MUCHAMMAD RIZAL",
      email: "muchammadrizal20@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9722471WTK",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    },
    {
      ...
      email: "hasanuddinsultan46382@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9323482WTK",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "MUHAMMAD FADLI",
      email: "muhammadfadlibkp2@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "0324468WTK",
      bidang: "Pemeliharaan Mesin 2 & Sipil",
    ...
    {
      name: "CANDRA YUNIOR WAHYU PRIBADI",
      email: "Candrayunior27@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9017068TKM",
      bidang: "Pemeliharaan Listrik",
    ...
    {
      name: "EKO ZUNI RAHMAN",
      email: "Junyrahman@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9517048TKM",
      bidang: "Pemeliharaan Listrik",
    ...
    {
      name: "MIFTAHUL JAMIL",
      email: "Miftahuljamil0202@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9117058TKM",
      bidang: "Pemeliharaan Listrik",
    ...
    {
      name: "MOHAMAD ASHIF",
      email: "Mohamad.ashif337@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9617064TKM",
      bidang: "Pemeliharaan Listrik",
    ...
    {
      name: "MUHAMMAD YUDHA FAHREZA",
      email: "Yudhafahreza1@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9717054TKM",
      bidang: "Pemeliharaan Listrik",
    ...
    {
      name: "SUTAN",
      email: "sutan.patuly.99@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9925485WTK",
      bidang: "Pemeliharaan Listrik",
    },
    {
      ...
      role: Role.PIC,
      nid: "8917005TB",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    },
    {
    ...
    {
      name: "ADJI NURHIDDAYAT",
      email: "Adji310798@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9817072TKM",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    ...
    {
      name: "DENO MANDALA PUTRA",
      email: "Denomandalaputra2@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9717066TKM",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    ...
    {
      name: "FANDIKA PRASETIADI RAHMAN",
      email: "Dhicaintipzh14@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "8817087TKM",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    },
    {
      ...
      email: "Gunawanw10051997@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9717091TKM",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    ...
    {
      name: "PANJI GUMELAR KAHURIPAN",
      email: "Panjigumelar93@yahoo.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9217053TKM",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    ...
    {
      name: "ANDI KURNIAWAN",
      email: "Kurniawan.andhy14@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9424473WTK",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    ...
    {
      name: "MUHAMAD FIKRI HAQQI JAYA NUGRAHA",
      email: "fikri.nugraha100@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9923480WTK",
      bidang: "Pemeliharaan Kontrol & Instrumen",
    ...
    {
      name: "RIKARDONIUS TUMANGGOR",
      email: "Rikardorikardo454@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9820465WTK",
      bidang: "Inventori Kontrol & Gudang",
    ...
    },
    {
      ...
      role: Role.PIC,
      nid: "8409588Z",
      bidang: "Enjiniring & Quality Assurance",
    },
    {
      ...
      role: Role.PIC,
      nid: "9115298ZJY",
      bidang: "Condition Based Maintenance",
    },
    {
      name: "RICARDO",
    ...
    {
      name: "SENO SATRIA",
      email: "Senosatria071197@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9717067TKM",
      bidang: "Condition Based Maintenance",
    ...
    {
      name: "MUHAMMAD NOOR APRILIANSYAH",
      email: "Toryapriliansyah@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9817059TKM",
      bidang: "Condition Based Maintenance",
    ...
    },
    {
      ...
      role: Role.PIC,
      nid: "9115227ZJY",
      bidang: "Manajemen Mutu Risiko & Kepatuhan",
    },
    {
      name: "MUHAMMAD ANZAR",
    ...
    },
    {
      ...
      email: "wahyubudi@plnnusantarapower.co.id",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9114153ZJY",
      bidang: "Business Support",
    },
    {
    ...
    },
    {
      ...
      email: "nindiatyasing88@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9424470WTK",
      bidang: "Keuangan",
    ...
    },
    {
      ...
      email: "nathasyamarchr@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9425481WTK",
      bidang: "Keuangan",
    ...
    {
      name: "YULIANI",
      email: "yuliani.hajari@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "93242906BLP",
      bidang: "SDM, Umum & CSR",
    ...
    {
      name: "REDNO ALIFUDIN",
      email: "rednoalifudin1@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9625478WTK",
      bidang: "Pengadaan",
    ...
    {
      name: "HERI SETIAWAN",
      email: "Herisetiawanbpn2@gmail.com",
      password: await bcrypt.hash("pic123", 10),
      role: Role.PIC,
      nid: "9617088TKM",
      bidang: "Koordinator",
