...
export function Header({ showSearch = true, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 h-16 border-b-3 border-black bg-white flex items-center justify-between px-4 md:px-6">
      ...
      <div className="flex items-center gap-3 ml-auto">
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-48 border-2 border-black brutal-shadow bg-white"
          >
