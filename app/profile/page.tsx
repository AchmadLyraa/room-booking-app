    ...
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Profile Card */}
          <Card className="md:col-span-1 bg-white text-black px-6 py-3 font-bold uppercase border-3 border-black brutal-shadow " >
          ...
          {/* User Info Card */}
          <Card className="md:col-span-2 bg-white text-black px-6 py-3 font-bold uppercase border-3 border-black brutal-shadow ">
            <CardHeader>
